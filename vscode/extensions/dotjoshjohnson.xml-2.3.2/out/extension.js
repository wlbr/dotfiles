...
function activate(context) {
    ...
    /* Linting Features */
    context.subscriptions.push(vscode_1.window.onDidChangeActiveTextEditor(_handleChangeActiveTextEditor), vscode_1.window.onDidChangeTextEditorSelection(_handleChangeTextEditorSelection));
    /* Tree View Features */
    ...
    switch (editor.document.languageId) {
        case constants.languageIds.xquery:
            vscode_1.languages
                ...
                .set(editor.document.uri, new linting_1.XQueryLinter().lint(editor.document.getText()));
            break;
    }
}
