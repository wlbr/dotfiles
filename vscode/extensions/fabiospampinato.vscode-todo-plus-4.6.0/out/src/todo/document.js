...
class Document {
    ...
    getTodosFinished() {
        return this.getItems(items_1.TodoFinished, consts_1.default.regexes.todoFinished);
    }
    getTodoFinishedAt(lineNumber, checkValidity) {
        return this.getItemAt(items_1.TodoFinished, lineNumber, checkValidity);
    }
    /* IS */
    isSupported() {
