...
function activate(context) {
    let disposable = vscode_1.commands.registerTextEditorCommand('generategotimelayout', (textEditor, textEditorEdit) => {
 ...
 * go time format.
 */
function parseSelection(textEditor, textEditorEdit) {
